<%
    ...
    if (userRole == null || !userRole.equals("f")) {
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" /> <!--icons library-->
    <style>
    ...
    <header>
      ...
      <nav>
        <ul>
          ...
          <li><a href="#" onclick="showSection('analytics')">Analytics <i class="fa-solid fa-indian-rupee-sign"></i></a></li>
          <li><a href="logout.jsp">Log Out <i class="fa-solid fa-arrow-right-from-bracket"></i></a></li>
          <li><a href="#" onclick="showSection('chats')">Chats <i class="fa-regular fa-comment-dots"></i></a></li>  
          <li><a href="#" onclick="showSection('agronomist')">Book Inspection <i class="fa-solid fa-user-secret"></i></a></li>
        </ul>
      </nav>
    </header>
    <div class="content">
      <aside>
        <ul>
          ...
          <li><a href="#" onclick="showSection('report')"><i class="fa-solid fa-pen-nib"></i> Report Management</a></li>
          <li><a href="#" onclick="showSection('order')"><i class="fa-solid fa-cart-arrow-down"></i> Order Management</a></li>
          <li><a href="#" onclick="showSection('sell')"><i class="fa-solid fa-scale-balanced"></i> Sell</a></li>
          <li><a href="#" onclick="showSection('harvest')"><i class="fa-solid fa-wheat-awn"></i> Harvest & Yield Management</a></li>
        </ul>
      </aside>
      <main>
        ...
        <section id="report" style="display: none">
          <iframe src="view-files.jsp" style="width:1100px; height:570px; border: none;"></iframe>
        </section>
        ...
        <section id="harvest" style="display: none">
          <h2>Harvest & Yield Management</h2>
            <iframe src="harvest.html" style="width:1000px; height:500px;"></iframe>
        </section>

        <section id="analytics" style="display: none">
            <h2>Analytics</h2>
            <iframe src="analytics/farmeranalytics.html" style="width:1000px; height:500px; border:none;"></iframe>
        </section>
            
        <section id="order" style="display: none">
          <h2>Order Management</h2>
            <iframe src="searchFilter.jsp" style="width:550px; height:500px; border:none;"></iframe>
            <iframe src="farmerOrders.jsp" style="width:550px; height:500px; border: none;"></iframe>
        </section>
           
        <section id="sell" style="display: none">
          <iframe src="selling/cropSell.jsp" style="width:1200px; height:575px;"></iframe>
        </section>
            
        <section id="chats" style="display: none">
          <iframe src="chats/chat.jsp" style="width:1100px; height:600px;"></iframe><br>
        </section>
          
        <section id="agronomist" style="display: none">
          <iframe src="inspection/contactAgronomist.jsp" style="width:500px; height:570px;"></iframe>
          <iframe src="inspection/viewStatus.jsp" style="width:600px; height:570px;"></iframe><br>
        </section>
        <section>
