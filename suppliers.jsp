<%
    ...
    if (userRole == null || !userRole.equals("s")) {
...
<html lang="en">
  <head>
    ...
    <script>
      ...
      function showChangePasswordForm() //MyProfile ChangePassword hiding
      {
    ...
    <header>
      ...
      <nav>
        <ul>
          ...
          <li><a href="#" onclick="showSection('buy')">Buy <i class="fa-solid fa-money-check-dollar"></i></a></li> 
        </ul>
      </nav>
    </header>
    <div class="content">
      <aside>
        <ul>
          ...
          <li><a href="#" onclick="showSection('inventory')"><i class="fa-solid fa-warehouse"></i> Inventory Management</a></li>
      ...
      <main>
        <section id="profile" style="display: none">
         ...
         <section id="inventory" style="display: none">
          ...
          <iframe src="inventoryOperations.html" style="width:400px; height:500px;"></iframe>
          <iframe src="displayInventory.html" style="width:785px; height:500px;"></iframe>
        </section>
        
        <section id="order" style="display: none">
          <h2>Order Management</h2>
          <iframe src="order.jsp" style="width:900px; height:500px; border:none;"></iframe>
        </section>

        <section id="analytics" style="display: none">
          <h2>Analytics</h2>
          <iframe src="analytics/supplieranalytics.html" style="width:910px; height:500px; border:none;"></iframe>
        </section>
         
        <section id="chats" style="display: none">
          <iframe src="chats/chat.jsp" style="width:950px; height:600px; border:none;"></iframe><br>
        </section>
            
        <section id="buy" style="display: none">
          <iframe src="selling/farmerRequest.jsp" style="width:1100px; height:500px; border:none;"></iframe><br>
        </section>
            
        <section id="history" style="display: none">
          <iframe src="SupplierOrderHistory.jsp" style="width:1000px; height:600px; border:none;"></iframe><br>
        </section>
            
        <section>
           <p style="font-family: Cooper; font-size: 50px; color: green;"> Welcome <%= fullname %> ! </p>
        </section>
      </main>
    </div>
    <footer>
